...
from .routes import products, auth, orders, admin_auth, admin_users, admin_stores, categories, users, chat, templates, delivery, seller, metrics, ai_assistant, ai_product_assistant
