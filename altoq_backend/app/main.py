...
from .routes import products, auth, orders, admin_auth, admin_users, admin_stores, categories, users, chat, templates, delivery, seller, store_assistant
...
app.include_router(store_assistant.router)
